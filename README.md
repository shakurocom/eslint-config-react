...
| --------------------------- | --------------------- | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tailwindStylesheet`        | `string`              | `undefined`                                          | Absolute path to your Tailwind v4 entry CSS file. Forwarded as both `config` and `cssConfigPath`, the names different v4 plugin releases read.                                                                                           |
...
| `tailwindParseKeyFunctions` | `string[]`            | `[]`                                                 | Functions whose object _keys_ are class names (`clsx({ flex: cond })`). Empty by default: plugin >=4.4.0 also reads plain identifier arguments of these functions as class names, so `clsx('flex', className)` would report `className`. |
